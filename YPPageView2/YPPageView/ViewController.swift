...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let titles = ["推荐", "游戏游戏游戏", "热门游戏", "趣玩游", "娱乐", "热门游戏2", "趣玩游2", "娱乐2","娱乐3","推荐", "游戏游戏游戏", "热门游戏", "趣玩游", "娱乐", "热门游戏2", "趣玩游2", "娱乐2","娱乐3","推荐", "游戏游戏游戏", "热门游戏", "趣玩游", "娱乐", "热门游戏2", "趣玩游2", "娱乐2","娱乐3","推荐", "游戏游戏游戏", "热门游戏", "趣玩游", "娱乐", "热门游戏2", "趣玩游2", "娱乐2","娱乐3"]
        ...
        for _ in 0..<titles.count {
         ...
         let pageVFrame = CGRect(x: 0, y: 64, width: view.bounds.width, height: view.bounds.height)
